...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="my-auto mb-0 content-title">المستخدمين</h4>
            <span class="mt-1 mb-0 mr-2 text-muted tx-13">/ قائمة المستخدمين</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
        ...
        <div class="card">
            <div class="pb-0 card-header">
                <div class="col-sm-6 col-md-4 col-xl-3 mg-t-20 mg-sm-t-0">
                    @can('اضافة مستخدم')
                        <a class="btn btn-outline-primary" href="{{ route('users.create') }}">اضافة مستخدم</a>
                    @endcan
                </div>
            </div>
            <div class="card-body">
                                    ...
                                    <td>
                                        @if ($user->status == 0)
                                            <span class="label text-success d-flex">
                                                <div class="ml-1 dot-label bg-success"></div> مفعل
                                            </span>
                                        @else
                                            <span class="label text-danger d-flex">
                                                <div class="ml-1 dot-label bg-danger"></div> غير مفعل
                                            </span>
                                        @endif
                                    </td>

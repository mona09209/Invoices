...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="my-auto mb-0 content-title">الفواتير</h4><span class="mt-1 mb-0 mr-2 text-muted tx-13">/ قائمة الفواتير</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                            ...
                            <div class="pb-0 card-header">
                                @can('اضافة فاتورة')
                                        <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale"
                                            href="{{ route('Invoices.create') }}"><i class="fas fa-plus"></i>&nbsp; اضافة فاتورة</a>
                                @endcan

                                @can('تصدير EXCEL')
                                        <a class="modal-effect btn btn-outline-primary"  data-effect="effect-scale"
                                        href="{{ url('export_invoice') }}"><i class="fas fa-file-download"></i>&nbsp;تصدير اكسيل</a>
                                 @endcan
										...
										<tbody>
											...
											<tr>
                                                ...
                                                <td><a
                                                    href="{{ url('Invoices_details') }}/{{ $invoice->id }}">{{ $invoice->section->name }}</a>
                                                </td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <a class="dropdown-item"
                                                           href=" {{ url('edit_invoice') }}/{{ $invoice->id }}">
                                                            <i class="text-danger fas fa-edit"></i>&nbsp;&nbsp;تعديل
                                                                    الفاتورة</a>
                                                                    @endcan

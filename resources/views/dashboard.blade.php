...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">الإحصائيات</h2>
                <p class="mg-b-0"></p>
            </div>
        </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 text-white tx-12 op-7">{{ \App\Models\Invoice::count() }}</p>
                            </div>
            ...
            <div class="overflow-hidden card sales-card bg-danger-gradient">
                <div class="pt-0 pt-3 pb-2 pl-3 pr-3">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h3 class="mb-1 text-white tx-20 font-weight-bold">

                                    {{ number_format(\App\Models\Invoice::where('value_status', 2)->sum('Total'), 2) }}

                                </h3>
                                <p class="mb-0 text-white tx-12 op-7">{{ \App\Models\Invoice::where('value_status', 2)->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="text-white fas fa-arrow-circle-up"></i>
            ...
            <div class="card">
                <div class="bg-transparent card-header pd-b-0 pd-t-20 bd-b-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="mb-0 card-title">نسبة احصائية الفواتير</h4>

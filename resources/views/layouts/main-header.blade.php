...
<div class="sticky main-header side-header nav nav-item">
                        ...
                        <div class="dropdown-menu">
                            <div class="text-right menu-header-content bg-primary">
                                <div class="d-flex">
                                    ...
                                    <span class="float-left my-auto mr-auto badge badge-pill badge-warning"><a
    ...
    <div class="main-notification-list Notification-scroll">
        @php
            $invoiceId = $notification->data['id'] ?? null; // Ensure 'id' exists
        @endphp
        <a class="p-3 d-flex border-bottom"
            href="{{ $invoiceId ? url('InvoicesDetails/' . $invoiceId) : '#' }}">
